/*
Software para inclus�o de pacientes com Covid 19,
...
Data da cria��o:    02/11/2020
�ltima atualiza��o: 16/11/2020
...
int main()
{
    setlocale(LC_ALL,"portuguese"); // Define a linguagem de sa�da como Portugu�s
...
int  aux2;
    ...
    if (idade >= 65 || aux2 == 0) {
      FILE *selfcare; // Cria vari�vel do tipo ponteiro para a cria��o do arquivo
